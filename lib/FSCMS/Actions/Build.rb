          ...
          if (lProcessInfo == nil)
            ...
            if (lProperties != nil)
              ...
              File.open("#{ioDeliverable.RealDir}/metadata.conf.rb", 'w') do |oFile|
                oFile << "# This file has been generated by FSCMS during build process of deliverable #{ioDeliverable.RealDir}. Check http://fscms.sourceforge.net for further information.\n"
                oFile << "{\n"
